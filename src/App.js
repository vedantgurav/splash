...
export default function App() {
    ...
    return (
        <div class="row" id="root">
            ...
            <div className="offset-md-1 col-md-5" id="swatches">
                ...
                />
                <p id="try" style={{ color: colors.primary }}>
                    Colours
                </p>
    ...
    function colorise(image) {
        ...
        tl.to(fullstop, 0.5, { alpha: 0 }).to(fullstop, 0.5, { alpha: 1 });
        ...
        fetch(
            "https://iriva52n5a.execute-api.ap-south-1.amazonaws.com/colors/colors",
            options
        )
            .then((response) => response.text())
            .then((result) => {
                painter(JSON.parse(JSON.parse(result).body));
                tl.pause(0).kill();
            })
